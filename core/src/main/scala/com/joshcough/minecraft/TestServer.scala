...
////    override def configureDbConfig(x$1: com.avaje.ebean.config.ServerConfig): Unit = sys error "todo"
...
//    override def getMap(x$1: Short): org.bukkit.map.MapView = sys error "todo"
...
//    override def getOnlinePlayers: Array[org.bukkit.entity.Player] = Array(player)
...
//    override def getServerId: String = sys error "todo"
//    override def getServerName: String = sys error "todo"
...
//    override def useExactLoginLocation: Boolean = sys error "todo"
