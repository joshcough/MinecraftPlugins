...
object ClojureInScalaTests extends Properties("ClojureInScalaTests") with BukkitEnrichment with TestHelpers {
  ...
  evalTest("constructorCall1", "(new com.joshcough.minecraft.Point2D 5 6)",                Point2D(5,6))
  evalTest("constructorCall2", "(new com.joshcough.minecraft.Point2D 5 6 nil)",            Point2D(5,6))
  evalTest("instanceCall0",    "(.toString (new com.joshcough.minecraft.Point2D 5 6))",    "(5,6)")
  ...
  evalTest("invokeWithFun1b",  "(.invokeFun1b (new com.joshcough.minecraft.Point2D 5 6) (fn (x) (+ x x)))",   16)
  evalTest("invokeWithFun2a",  "(.invokeFun2a (new com.joshcough.minecraft.Point2D 5 6) (fn (x y) (* 9 8)))", 72)
